...
.controller('TodoCtrl', function($scope , $ionicPopup ,$ionicListDelegate) {
  $scope.tasks =
    [
      {title: "Premiére", completed: false},
      {title: "Deuxiéme", completed: false},
      {title: "Troisiéme", completed: false},
    ];

    $scope.newTask = function() {
      $ionicPopup.prompt({
        title: "Nouvelle tâche",
        template: "Entrer la tâche:",
        inputPlaceholder: "Qu'avez-vous besoin de faire?",
        okText: 'Soumettre',
        cancelText : 'Annuler'
